...
# Session with polite headers and retry logic -- created lazily (P7: no
# session at import).
SESSION = None
...
# Re-anchored at scrape_all() entry (P7); the import-time value serves
# direct calls to budget_exceeded() outside the pipeline.
